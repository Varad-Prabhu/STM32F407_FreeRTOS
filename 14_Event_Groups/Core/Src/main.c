...
int main(void)
{
  ...
  xTaskCreate(DataTask, "DataTask", 128, NULL, 2, &dataTaskHandle);
  xTaskCreate(ProcessingTask, "ProcessingTask", 128, NULL, 2, &processingTaskHandle);
...
static void SensorTask(void *argument)
{
    ...
    for (;;)
    {
        len = snprintf(msg, sizeof(msg), "Sensor ready\r\n");
...
static void DataTask(void *argument)
{
    ...
    for (;;)
    {
        len = snprintf(msg, sizeof(msg), "Data ready\r\n");
        HAL_UART_Transmit(&huart2, (uint8_t *)msg, len, HAL_MAX_DELAY);
...
static void ProcessingTask(void *argument)
{
    ...
    for (;;)
    {
        ...
        {
            len = snprintf(msg, sizeof(msg), "Both events received\r\n");
            HAL_UART_Transmit(&huart2, (uint8_t *)msg, len, HAL_MAX_DELAY);

            len = snprintf(msg, sizeof(msg), "Processing data\r\n");
            HAL_UART_Transmit(&huart2, (uint8_t *)msg, len, HAL_MAX_DELAY);
        }
    }
}
